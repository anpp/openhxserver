...
static unsigned short const loader2[] = {
    /*000*/ 000240, 000430, 000000, 000000, 000000, 000000, 000000, 000000,
    /*020*/ 000000, 000000, 000000, 000000, 000000, 000000, 000000, 000000,
    /*040*/ 000000, 000000, 000000, 000000, 000000, 000000, 000000, 000000,
    /*060*/ 000000, 000000, 010046, 010700, 062700, 000072, 010037, 000030,
    /*100*/ 012737, 000340, 000032, 012600, 012701, 001000, 013702, 000444,
    /*120*/ 006302, 0105737, 0176570, 0100375, 0113721, 0176572, 0077206, 013767,
    /*140*/ 000040, 000264, 013767, 000042, 000254, 013706, 000042, 013707,
    /*160*/ 000040, 010067, 000234, 011600, 014000, 042766, 000001, 000002,
    /*200*/ 0122700, 000374, 0001427, 0122700, 000375, 0001424, 0122700, 000341,
    /*220*/ 0001010, 0105737, 0177564, 0100016, 016700, 000166, 0110037, 0177566,
    /*240*/ 000002, 0122700, 000340, 0001013, 0105737, 0177560, 0100003, 0113700,
    /*260*/ 0177562, 000002, 016700, 000132, 005266, 000002, 000002, 0122700,
    /*300*/ 000351, 0001014, 016700, 000112, 0105737, 0177564, 0100375, 0031027,
    /*320*/ 000200, 0001003, 0112037, 0177566, 0001367, 000002, 0122700, 000354,
    /*340*/ 0001017, 016700, 000054, 042700, 000001, 022700, 0177776, 0001403,
    /*360*/ 026700, 000040, 0103002, 016700, 000032, 010037, 000050, 000002,
    /*400*/ 0122700, 000350, 0001004, 016706, 000014, 016707, 000012, 000000,
    /*420*/ 000721, 000000, 0140000, 000000, 000000, 000000, 000000, 000000,
    /*440*/ 000000, 000000, 000000, 000000, 000000, 000000, 000000, 000000,
    /*460*/ 000000, 000000, 000000, 000000, 000000, 000000, 000000, 000000,
};
...
/*
    ...
    //*(wbuffer + 0324/2) = (23552) / 2;
    *(wbuffer + 0324 / 2) = (buffer.size() - 512) / 2;
*/

    wbuffer[0] = loader2[0];
    wbuffer[1] = loader2[1];

    //*(wbuffer + 0444 / 2) = (*(wbuffer + 050/2) - 0776) / 2;
    for (auto i = 050/2; i < 0440/2; ++i)  wbuffer[i] = loader2[i];
    *(wbuffer + 0444 / 2) = (buffer.size() - 512) / 2;
